...
from qllr.settings import INITIAL_R1_MEAN, INITIAL_R2_VALUE, SUPPORTED_GAMETYPES, AVG_PERF_GAMETYPES
...
async def fetch(
    ...
    for steam_id in map(str, steam_ids):
        ...
        for gametype in SUPPORTED_GAMETYPES:
            ...
            if bigger_numbers:
                players[steam_id][gametype]["elo"] = int(players[steam_id][gametype]["elo"] * 60)
