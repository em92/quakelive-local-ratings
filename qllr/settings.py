...
for gt in SUPPORTED_GAMETYPES:
    ...
    INITIAL_R1_MEAN[gt] = config("INITIAL_R1_MEAN_{}".format(gt.upper()), cast=float, default=MU)
    INITIAL_R1_DEVIATION[gt] = config("INITIAL_R2_DEVIATION_{}".format(gt.upper()), cast=float, default=SIGMA)
